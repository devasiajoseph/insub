...
(def bootstrap-input-container-class "form-group")
(def bootstrap-input-container-class-error "form-group has-error")
(def bootstrap-form-horizontal "form-horizontal")
(def boostrap-input-class "form-control")
(def bootstrap-primary-button-class "btn btn-primary")
